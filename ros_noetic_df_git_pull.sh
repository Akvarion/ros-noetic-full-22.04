#!/bin/bash
# Packages enclosed in '#' are for noetic desktop full
# run this while you are in ros_noetic_22.04/catkin_ws/src in terminal
...
git clone https://github.com/ros/nodelet_core.git -b 1.10.0
...
#additional stuff required during build, ros-drivers
